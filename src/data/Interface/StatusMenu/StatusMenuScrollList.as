package
{
   ...
   public class StatusMenuScrollList extends MovieClip
   {
      ...
      private var pScrollBoundPositions:Point = new Point(0,0);
      
      private var pMouseWheelThresholds:Point = new Point(0,0);
	  ...
	  private const ATTRIBUTE_ENTRY:String = "AttributeEntryClip";
      
	  private const SPECIAL_ATTRIBUTES_DISPLAY:String = "SPECIAL_ATTRIBUTES_DISPLAY";
	  ...
	  //BEGIN S.P.E.C.I.A.L. Display
      public function AddSpecialAttributes(param1:Object) : void
      {
		//for each(effectGroup in param1)
		//{
			 var _loc3_:Object = param1;
			 var _loc4_:* = _loc3_.sName == SPECIAL_ATTRIBUTES_DISPLAY;
			 var _loc6_:* = false;
			 //if(_loc4_)
			 //{
				//this.AddEffectGroupHeader(_loc3_)
				var _loc2_:uint = 0;
				var _loc7_:Object;
				while(_loc2_ < _loc3_.aEffects.length)
				{
				 	_loc7_ = _loc3_.aEffects[_loc2_];
					_loc6_ = _loc2_ == _loc3_.aEffects.length - 1;
					//this.AddActiveEffect(_loc3_,_loc6_);
					//var _loc5_:BuffEntry = this.CreateMovieClip(this.BUFF_ENTRY,_loc6_) as BuffEntry;
					var _loc5_:AttributeEntry = this.CreateMovieClip(this.ATTRIBUTE_ENTRY,_loc6_) as AttributeEntry;
					_loc5_.SetEntry(_loc7_);
					this.PanelModularHeight += _loc5_.height;
					_loc2_++;
				} 
			 //}		
		//}
      }
      //END S.P.E.C.I.A.L. Display
   }
}
